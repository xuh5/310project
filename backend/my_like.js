    ...
    try {
        ...
        var rds_response = new Promise((resolve, reject) => {
            try {
                ...
                var sql = "Select Likes.*, Review.*, User.Username, Movie.Title from Likes join Review join User join Movie on Likes.ReviewID = Review.ReviewID and Review.UserID = User.UserID and Review.MovieID = Movie.MovieID where Likes.UserID = ?;";
