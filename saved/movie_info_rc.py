...
class Ui_Form(QtWidgets.QWidget):
    #zyt
    name_clicked = pyqtSignal(str)  # 信号，传递电影名称
    buttonClicked = pyqtSignal(object)  # 发射整个 widget 对象
    ##
    def __init__(self, data):
        super(Ui_Form, self).__init__()
        self.setupUi(data)
        #zyt
        self.name_pushbutton.clicked.connect(lambda: self.buttonClicked.emit(self))
...
"}")
        ...
        #zyt
        self.name_pushbutton.clicked.connect(self.on_name_clicked)
        ####
    ...
    def on_name_clicked(self):
        self.name_clicked.emit(self.name_pushbutton.text())  # 发送信号
    ###
